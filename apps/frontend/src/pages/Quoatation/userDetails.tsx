    ...
    <div className="space-y-5">
      <div className="bg-[#EDF2FF] p-3 rounded-lg text-sm overflow-hidden">
        ...
        <div className="grid md:grid-cols-2">
          ...
          <span className="grid grid-cols-2 md:flex gap-3">
            ...
            <Text>
              {
                spacetime(quotation.to.movementDate.seconds)
                  .format('nice')
                  .split(',')[0]
              }
      ...
      <div>
        ...
        <Text className="text-sm">
          ...
          <span className="font-semibold">{quotation.fromAndTo.from}</span> to{' '}
          <span className="font-semibold">{quotation.fromAndTo.to}</span> . We
