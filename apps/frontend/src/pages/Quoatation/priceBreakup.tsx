  ...
  return (
    <div>
      <div className="p-1 bg-[#EDF2FF] grid grid-cols-5 text-sm font-semibold">
        <Text className="col-span-4 justify-self-center mr-5 md:mr-[190px]">
          Particulars
        </Text>
        <Text>Amount</Text>
      </div>
        ...
        <div className="col-span-4 grid grid-cols-3 py-1">
          <div className="col-span-2 grid grid-cols-2">
            <div>
              ...
              <Text className="w-11/12 md:w-3/4 text-gray-400 text-[6px] md:text-[10px]">
                (inclusive of Loading, Unloading, packing, Unpacking)
              </Text>
            </div>
            {quotation.labourCharges.lift ? (
              ...
              <div>
                <Text className="text-sm">
                  {quotation.labourCharges.config} + No lift
                </Text>
                <Text className="text-gray-400 text-[6px] md:text-[10px]">
                  ({quotation.labourCharges.manPower}+2 Men)
                </Text>
              </div>
            )}
          </div>
          <div className="">
            <Text className="text-sm">
              ₹{quotation.labourCharges.costPerMen}
            </Text>
            <Text className="text-gray-400 text-[6px] md:text-[10px]">
              (
              {quotation.labourCharges.lift
                ? quotation.labourCharges.manPower
                : quotation.labourCharges.manPower + 2}{' '}
              Men * ₹{quotation.labourCharges.costPerMen})
            </Text>
          </div>
        </div>
        <div className="p-1">
      ...
      <div className="col-span-4 grid grid-cols-3 py-1">
        <div className="col-span-2 grid grid-cols-2">
          <div>
            ...
            <Text
              size={8}
              className="w-11/12 md:w-3/4 text-gray-400 text-[6px] md:text-[10px]"
            >
              (inclusive of packing material used)
            </Text>
          </div>
          <Text className="text-sm">
            {quotation.packingCharges.totalCubeM} CFT
          </Text>
        </div>
        <div className="">
          <Text className="text-sm">
          ...
          <Text className="text-gray-400 text-[6px] md:text-[10px]">
            ({quotation.packingCharges.totalCubeM} CFT x ₹
            {quotation.packingCharges.packingCostPerCubeM})
          </Text>
        </div>
      </div>
    ...
    <div className="p-1 grid grid-cols-5 text-sm">
      <div className="col-span-4 grid grid-cols-3 py-1">
        <div className="col-span-2 grid grid-cols-3 md:grid-cols-2">
          ...
          <div>
            <Text className="text-sm">
              {quotation.TransportationCost.config}
            </Text>
            <Text className="text-gray-400 text-[6px] md:text-[10px]">
              {quotation.TransportationCost.details.name}
            </Text>
          </div>
        </div>
        <div className="">
    ...
    <div className="p-1 grid grid-cols-5 text-sm">
      <div className="col-span-4 grid grid-cols-3 py-1">
        ...
        <div className="">
          ...
          <Text className="text-gray-400 text-[6px] md:text-[10px]">
            ({quotation.costPerKM.distance} km x ₹{quotation.costPerKM.perKM})
          </Text>
        </div>
      </div>
      <div className="">
  ...
  return (
    <div className="p-1 grid grid-cols-5 text-sm">
      <div className="py-1 col-span-4">
        <Text className="w-10/12 text-xs">
          Freight on value (F.O.V) 3.00% of the total goods values of Rs{' '}
          {quotation.fov.totalValueOfGoods}
        </Text>
      </div>
      <div className="">
...
const Surcharge = () => {
  ...
  return (
    <div className="p-1 grid grid-cols-5 text-sm">
      <div className="py-1 col-span-4">
        <Text className="w-10/12 text-xs">
          Surcharge @ 10.00 % of the above total (Not applicable for Defense
          Personnel)
        </Text>
      </div>
      <div className="">
