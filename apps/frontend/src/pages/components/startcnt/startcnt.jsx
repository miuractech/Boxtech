...
const StartCnt = () => {
    ...
    return (
        <div id="seperate-container" className="h-[800px] w-[100%] sm:h-auto">
            <div>
                <div className="my-[10%] mx-[12%] sm:mx-[10%] sm:my-[15%]">
                    ...
                    <button
                        ...
                        className="bg-[#edbd0f] rounded-[5px] p-[10px] my-[20px] text-white sm:w-full">
                        Start for free
                    </button>
                    {/* </Link> */}
            ...
            <div>
                <img className='h-[80%] w-[100%] mr-[10%] sm:p-[10px] sm:h-[62vh] sm:mr-0' src={mainimage} alt="Alt img" />
            </div>
        </div>
    )
}
